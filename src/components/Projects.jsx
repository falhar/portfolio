...
const projects = [
  {
    ...
    desc: 'A comprehensive fitness marketplace connecting dancers, studios, and enthusiasts. Features class booking, live schedules, multi-user accounts, artists directory, community, achievements, and a full e-commerce checkout — with native iOS & Android apps.',
    highlights: [
      'Cross-platform iOS & Android via Capacitor',
      'Real-time schedule management system',
      'GraphQL API with Apollo Client',
      'Stripe-powered class & package checkout',
      'Google Maps integration for studio discovery',
    ],
    tech: ['Next.js', 'GraphQL', 'Apollo', 'Capacitor', 'Stripe', 'TailwindCSS', 'PostgreSQL', 'Docker'],
    accent: '#6366f1',
